...
public class IncomingRequestViewHolder extends RecyclerView.ViewHolder implements ValueEventListener, View.OnClickListener {
    ...
    public IncomingRequestViewHolder(@NonNull View itemView, MOVCurrencyCache currencyCache, OnTransactionListener onTransactionListener) {
        super(itemView);

        itemView.setOnClickListener(this);
        this.onTransactionListener = onTransactionListener;

        this.sender = itemView.findViewById(R.id.incoming_request_sender);
        this.amount = itemView.findViewById(R.id.incoming_request_amount);
        this.contactImage = itemView.findViewById(R.id.incoming_request_contact_image);
