...
public class HistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HistoryAdapter(List<MOVTransaction> transactions, int defaultCellHeight, OnTransactionListener onTransactionListener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder.getItemViewType() == VIEW_TYPE_FROM || holder.getItemViewType() == VIEW_TYPE_TO) {
            ...
            if(transactionPosition > 0) {
                ...
                // Cell height ranges from 1 to 25 times its height depending on how big the
                // transaction date difference is.
